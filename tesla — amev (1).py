...
class Window(Frame):
    ...
    def changeTlc(self):
        ...
        if color_code[1] in yellow:
            ...
            load = Image.open("for the tail lights of teslapeach.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslared.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslabrown.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslaorange.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslaolive.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslagrey.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslalime.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslagreen.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslablue.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslaviolet.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslawhite.jpg")
            tail = ImageTk.PhotoImage(load)
            ...
            load = Image.open("for the tail lights of teslapink.jpg")
            tail = ImageTk.PhotoImage(load)
